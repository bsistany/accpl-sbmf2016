...
\email{bsistany@yahoo.ca}, \email{afelty@uottawa.ca}
}
...
The theorem \syn{trans_agreement_dec2} in Listing~\ref{lst:agreementdecidablecoq} is the declaration of the main correctness result for \ac{ACCPL}. Together with proofs for other theorems and lemmas, we have ``certified'' \ac{ACCPL} correct by proving this theorem.
...
to defining semantics for \ac{pbac} based languages such that one can
...
policies, and prove in correct. Their \ac{xacml} subset includes some
