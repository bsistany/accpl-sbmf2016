...
the \syn{<prin>} in the agreement to those in the \syn{<prin>} of the
constraint.
%
For example, the constraint of ``the user being Alice'' is a
constraint of the principal kind. A count constraint refers to the
...
%*** New sentence.  Please check.  There is nothing to do if you
%agree.
